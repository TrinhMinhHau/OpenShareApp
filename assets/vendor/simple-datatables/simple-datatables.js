            ...
            (function () {
              ...
              function d(t, e, s) {
                ...
                switch (o) {
                  ...
                  case s._const.addTextElement:
                    var u;
                    if (
                      ((h = (u = d.slice()).splice(u.length - 1, 1)[0]),
                ...
                return (
                  s.postDiffApply({ diff: c.diff, node: c.node, newNode: n }),
                  !0
                );
              }
              function c(t, e, s) {
              ...
              var h = function (t) {
                ...
                f = function (t) {
                  return (
                    ...
                    delete t.innerDone,
                    delete t.valueDone,
                    !t.childNodes || t.childNodes.every(f)
                  );
                },
                m = function (t) {
                      ...
                      if (t.nodeName !== e.nodeName) {
                        ...
                        return [
                          new y()
                            ...
                            .setValue(this.options._const.oldValue, m(t))
                            .setValue(this.options._const.newValue, m(e))
                            ...
                            if (i.length > n.length)
                              ...
                              r = r.concat([
                                new y()
                                  ...
                                  .setValue(this.options._const.oldValue, m(u))
                                  .setValue(this.options._const.newValue, m(p))
                                  .setValue(
                                    this.options._const.route,
                                    s.concat(l)
                                  ),
                            ...
                            if ("#text" === (l = t.childNodes[w]).nodeName)
                              ...
                              g.push(
                                new y()
                                  ...
                                  .setValue(this.options._const.element, m(l))
                              ),
                                u.splice(_, 1),
                                (f = Math.min(u.length, p.length)),
                                (_ -= 1);
                            ...
                            !(function (t, e, s) {
                              switch (e[s._const.action]) {
                                case s._const.addAttribute:
                                  ...
                                  break;
                                case s._const.modifyAttribute:
                                  c(e, s._const.oldValue, s._const.newValue),
                                    d(t, e, s);
                                  break;
                                case s._const.removeAttribute:
              ...
              const A = (
                ...
                P = (
                  ...
                  if (
                    ((_.attributes.class = _.attributes.class
                      ? `${_.attributes.class} ${o.table}`
                      : o.table),
                    l || d || v)
                  ) {
                    const t = A(
                        ...
                        (this.$d = (function (t, e, s) {
                          try {
                            ...
                            return h
                              ...
                              : s
                              ? new Date(Date.UTC(m, g, f, b, v, _, w))
                              : new Date(m, g, f, b, v, _, w);
                          } catch (t) {
                            return new Date("");
                          }
                        })(e, r, i)),
              ...
              const Q = {
                  ...
                  labels: {
                    ...
                    perPage: "trường mỗi trang",
                    noRows: "Không có dữ liệu !!!",
                    noResults: "Không tìm thấy kết quả",
                    info: "Hiển thị {start} đến {end} trong số {rows} trường",
                  },
                  template: (t, e) =>
                ...
                X = (t, e, s, i, n) => {
                  let a = [];
                  if (
                    (n.firstLast && a.push(Z(1, n.firstText, n)), n.nextPrev)
                  ) {
                    const e = t ? 1 : s - 1;
                    a.push(Z(e, n.prevText, n, { hidden: t }));
                  }
                  let o = [...Array(i).keys()].map((t) =>
                    Z(t + 1, String(t + 1), n, { active: t === s - 1 })
                  );
                  if (
                    (n.truncatePager &&
                      (o = ((t, e, s, i) => {
              ...
              class K {
                ...
                editCellModal() {
                  const t = this.data.cell,
                    ...
                    a = [
                      ...
                      `<label class='${this.options.classes.label}'>${n(
                        i
                      )}</label>`,
                      `<input class='${this.options.classes.input}' value='${n(
                ...
                rowRender(t, e, s) {
                  ...
                  if (this.editingCell) {
                    e.childNodes[
                      o(this.data.columnIndex, this.dt.columns.settings)
                    ].childNodes = [
                      {
                        nodeName: "INPUT",
                        attributes: {
                  ...
                  if (Array.isArray(e)) {
                    ...
                    e.forEach((e, i) => {
                      ...
                      Object.entries(e).forEach(([e, s]) => {
                        const a = t.indexOf(e);
                        a > -1
                          ? (n[a] = F(s, this.columns.settings[a]))
                          : this.hasHeadings ||
                            this.hasRows ||
                            0 !== i ||
                            ((n[t.length] = F(
                    ...
                    t(e) &&
                      (!e.headings || this.hasHeadings || this.hasRows
                        ? e.data &&
                          ...
                          (s = e.data.map((t) =>
                            t.map((t, e) => F(t, this.columns.settings[e]))
                          ))
                        : (this.data = U(
                            e,
                            void 0,
