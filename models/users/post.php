...
class Post
{
    ...
    public function displayRequest()
    {
        $query = "SELECT yc.idRequest, yc.idPost, yc.idUserRequest, yc.message, yc.requestDate,yc.status,
            p.title, p.description, p.postDate,p.approvDate, p.address, p.photos, p.idType,u.name,d.nameType,u.photoURL,yc.messageResponse,yc.reviewDay,p.idUser,yc.messageAfterReceiveGood,yc.ratingStar
            FROM yeucau yc 
    ...
    public function displayManegerRequest()
    {
        ...
        p.title, p.description, p.postDate,p.approvDate, p.address, p.photos, p.idType,u.name,d.nameType,u.photoURL,yc.messageResponse,yc.messageAfterReceiveGood,yc.ratingStar
        FROM yeucau yc
        JOIN baiviet p ON yc.idPost = p.idPost
