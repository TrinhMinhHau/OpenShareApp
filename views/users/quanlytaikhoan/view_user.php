    ...
    <div class="profile-info">
        <div class="info-col">
            <div class="profile-intro">
                ...
                <ul>
                    <li>
                        <img src="../assests/images/email-icon2.png" alt="" /> <?php if ($data6[0]['email'] == null) echo "Chưa cập nhật";
                                                                                else echo $data6[0]['email']  ?>
                    </li>
                    <li>
                        <img src="../assests/images/icon-phone.png" alt="" /><?php if ($data6[0]['phoneNumber'] == null) echo "Chưa cập nhật";
                                                                                else echo $data6[0]['phoneNumber']  ?>
                    </li>
                </ul>
                <hr />
                <div class="update-info">
        ...
        <div class="post-col">
            ...
            ?>
                ...
                ?>
                    ...
                    <?php if ($data1[$i]['isShow'] == 1 && $data1[$i]['soluongdocho'] > 0) : ?>
